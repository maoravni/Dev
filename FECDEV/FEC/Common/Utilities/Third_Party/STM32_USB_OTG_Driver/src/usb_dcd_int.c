...
static uint32_t DCD_HandleSof_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  USBD_DCD_INT_fops->SOF(pdev);//Igor
...
//  USB_OTG_GINTSTS_TypeDef  gintsts;
  ...
  USB_OTG_WRITE_REG32( &pdev->regs.DREGS->DOEPMSK, doepmsk.d32 );//going to ??
#ifdef USB_OTG_HS_DEDICATED_EP1_ENABLED   
  ...
  USB_OTG_WRITE_REG32( &pdev->regs.DREGS->DIEPMSK, diepmsk.d32 );//going to hardware fault
#ifdef USB_OTG_HS_DEDICATED_EP1_ENABLED  
