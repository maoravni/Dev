...
#define PLATFORM_NAME	"Simple Cortex"
#define CPU_NAME		"LPC1769"
#define CMDLINESIZE		80	
#define getopt umon_getopt

/* Force APPRAMBASE to be the upper 32K of the SRAM
 * in the 1769...
 */
#define APPRAMBASE_OVERRIDE 0x2007c000
 ...
 */
#define FLASHBANKS				1
#define FLASH_BANK0_BASE_ADDR  	0
#define FLASH_PROTECT_RANGE  	"0-19"		/* 0-18 protects first 128K */
#define FLASH_LARGEST_SECTOR    0x8000
...
#define TFSSPARESIZE    		0x8000
#define TFSSTART        		0x50000
#define TFSEND          		0x77fff
#define TFSSPARE        		(TFSEND+1)
#define TFSSECTORCOUNT			5		/* Does not include SPARE */
#else
#define TFSSPARESIZE    		0
#define TFSSTART        		0x50000
#define TFSEND          		0x7ffff
#define TFSSPARE        		0
...
#define TIMER_TICKS_PER_MSEC ((SYSCLKFREQ/1000)/4)

#if INCLUDE_FLASH
#define LPC17XX_512 1
#define LPC17XX_256 0
#define LPC17XX_128 0
#define LPC17XX_064	0
#define LPC17XX_032	0
#endif
