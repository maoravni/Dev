...
#ifndef INCLUDE_MONLIB
#define INCLUDE_MONLIB 1
#endif
...
/* See chario/putchar() for information...
 */
#define REMOTE_PUTCHAR_REPLACE	-1
#define REMOTE_PUTCHAR_INSERT	-2
#define REMOTE_PUTCHAR_INSERTT	-3
