...
init2(void)
{
	...
	if (StateOfMonitor == INITIALIZE)
		...
		rc = FlashInit();
#else
    	FlashInit();		/* Init flashop data structures and (possibly) */
#endif						/* the relocatable functions.  This MUST be */
