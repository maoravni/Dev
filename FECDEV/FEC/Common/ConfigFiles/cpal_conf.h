...
#define CPAL_EnterCriticalSection_UserCallback        taskENTER_CRITICAL
#define CPAL_ExitCriticalSection_UserCallback         taskEXIT_CRITICAL
...
#define _CPAL_TIMEOUT_INIT() TimeoutEnabled = 1
#define _CPAL_TIMEOUT_DEINIT() TimeoutEnabled = 0

#define CPAL_I2C_TIMEOUT_Manager       vApplicationTickHook         /*<! This callback is used to handle Timeout error.
...
#define I2C1_IT_OFFSET_PREPRIO          (uint8_t)(configMAX_SYSCALL_INTERRUPT_PRIORITY >> 4) + 3      /* I2C1 PREEMPTION PRIORITY Offset */
...
#define I2C_Struct I2C1_DevStructure
