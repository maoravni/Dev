...
typedef union
{
  ...
  u32           u32_Status_u8;          //R/W[1,7]
  u32           u32_Head_Address_u8;    //R/W
  ...
  u32           u32_Factory_Default;    // W
  u32           u32_Flicker_Filter_u16; //R/W
  u32           u32_Laser_Control_u8;   //R/W
  u32           u32_Cali_Date;          //R
  u32           u32_Cali_Time;          //R
