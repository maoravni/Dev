...
module Logic_Function (
	...
	localparam IBT_DRYER		= 4'b0001;
	localparam CCS1				= 4'b0010;
	localparam CCS2				= 4'b0011;
	localparam CCS3				= 4'b0100;
	localparam SOFT_MODE		= 4'b0101;
	localparam VENTILATION1		= 4'b0110;
	localparam VENTILATION2		= 4'b0111;
	localparam COLD_WATER1		= 4'b1000;
	localparam COLD_WATER2		= 4'b1001;
	localparam COLD_WATER3		= 4'b1010;
	localparam HW_VALIDATION	= 4'b1011;
	localparam APPLICATOR		= 4'b1100;
	localparam CCS4		        = 4'b1101;
		...
		begin
			...
			begin
				...
				case(Function_Select)
					...
					CCS3:
					begin
						DO_0 <= OC_0;	// Output - Tank Heater.
						DO_1 <= OC_1;	// Output - Tub Fill pump inverter forward.
						DO_2 <= OC_2;	// Output - HTX motor fan.
						DO_3 <= OC_3;	// Output - Tub Drain pump inverter forward.
						DO_4 <= OC_4;	// Output - Tub Fill pump inverter rellay enable.
						DO_5 <= OC_5;	// Output - HTX pump Forward.
						interrupt <= `ZERO;
					end	
					CCS4:
					begin
