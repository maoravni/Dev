...
static void ETH_MACDMA_Config(void)
{
  ...
  /*------------------------   MAC   -----------------------------------*/
  ETH_InitStructure.ETH_AutoNegotiation = ETH_AutoNegotiation_Disable;//ETH_AutoNegotiation_Enable;  Igor 2012/02/21
...
void ETH_NVIC_Config(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = (uint8_t)(configMAX_SYSCALL_INTERRUPT_PRIORITY>>4)+1;  //mast be above configMAX_SYSCALL_INTERRUPT_PRIORITY (11)
...
void Eth_Link_EXTIConfig(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority =(uint8_t)(configMAX_SYSCALL_INTERRUPT_PRIORITY>>4);
  NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
  NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
  NVIC_Init(&NVIC_InitStructure);
}
