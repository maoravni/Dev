...
#define _EEPROM_DB_INT_ID_SIZE   ( _EEPROM_DB_INT_MAX_NUM_OF_ID_INDX * sizeof(UINT32)*2) //256
#define _EEPROM_DB_INT_UNIT_SIZE  (_EEPROM_DB_INT_ID_SIZE *  _EEPROM_DB_INT_MAX_NUM_OF_IDS) //256x64= 16384
#define _EEPROM_DB_INT_INSTANSE_SIZE (_EEPROM_DB_MAX_NUM_OF_UNITS *_EEPROM_DB_INT_UNIT_SIZE) //4x 16384= 65536
#define _EEPROM_DB_INT_TOTAL_SIZE   (_EEPROM_DB_MAX_NUM_OF_INSTANSES *_EEPROM_DB_INT_INSTANSE_SIZE) //8 x 65535 =512KB

//macro that find the starting address in the EEPROM for specipic unit
#define EEPROM_DB_INT_UNIT_ADDR(Instanse,Unit) (_EEPROM_DB_START_ADDR+(Instanse * _EEPROM_DB_INT_INSTANSE_SIZE) + \
  (Unit * _EEPROM_DB_INT_UNIT_SIZE))
...
#define _EEPROM_DB_STR_ID_SIZE   (_EEPROM_DB_STR_MAX_NUM_OF_ID_INDX * (MAX_CFG_STR_SIZE+sizeof(UINT32))) //260
#define _EEPROM_DB_STR_UNIT_SIZE  (_EEPROM_DB_STR_MAX_NUM_OF_IDS *_EEPROM_DB_STR_ID_SIZE ) //260x8=2080
#define _EEPROM_DB_STR_INSTANSE_SIZE (_EEPROM_DB_MAX_NUM_OF_UNITS  * _EEPROM_DB_STR_UNIT_SIZE ) //4 x 2080= 8320
#define _EEPROM_DB_STR_TOTAL_SIZE   (_EEPROM_DB_MAX_NUM_OF_INSTANSES *_EEPROM_DB_STR_INSTANSE_SIZE) //8 x 8320=66560 = 65K 

//macro that find the starting address in the EEPROM for specipic unit
#define EEPROM_DB_STR_UNIT_ADDR(Instanse,Unit) (_EEPROM_DB_START_ADDR+(Instanse * _EEPROM_DB_STR_INSTANSE_SIZE) + \
  (Unit * _EEPROM_DB_STR_UNIT_SIZE))
