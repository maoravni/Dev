...
/*                               MBS_TX_LED   MBS_RX_LED  CAN_TX_LED  CAN_RX_LED  LABL_LED1  LABL_LED2    LABL_LED3    LABL_LED4    LABL_LED5    LABL_LED6    LABL_LED7    LABL_LED8    LABL_LED9    DIP_LED   ALIVE_LED */
  ...
  static GPIO_TypeDef* PortOf[] = {GPIOG,      GPIOG,      GPIOG,      GPIOF,      GPIOD,      GPIOD,       GPIOE,       GPIOG,       GPIOG,       GPIOF,       GPIOF,       GPIOF,       GPIOF,       GPIOD,      GPIOC      };
                         
  static const uint16_t PinOf[] = {GPIO_Pin_4, GPIO_Pin_3, GPIO_Pin_2, GPIO_Pin_11, GPIO_Pin_11, GPIO_Pin_10, GPIO_Pin_15, GPIO_Pin_1, GPIO_Pin_0, GPIO_Pin_15, GPIO_Pin_14, GPIO_Pin_13, GPIO_Pin_12, GPIO_Pin_7, GPIO_Pin_13};
