...
/* Ethernet pins configuration ************************************************/
   /*
        ...
        ETH_MII_TXD2 ---------------------> PC2
        ETH_MII_TXD3 ---------------------> PB8
        ETH_MII_RX_CLK/ETH_RMII_REF_CLK---> PA1 v
        ETH_MII_RX_DV/ETH_RMII_CRS_DV ----> PA7 v
        ETH_MII_RXD0/ETH_RMII_RXD0 -------> PC4 v
        ETH_MII_RXD1/ETH_RMII_RXD1 -------> PC5 v
        ETH_MII_TX_EN/ETH_RMII_TX_EN -----> PB11 (Was G11)
        ETH_MII_TXD0/ETH_RMII_TXD0 -------> PB12 (Was G13)
        ETH_MII_TXD1/ETH_RMII_TXD1 -------> PB13 (Was G14)
                                                  */
