...
/* Ethernet pins configuration ************************************************/
   /*
        ...
        ETH_MII_TX_EN/ETH_RMII_TX_EN -----> PG11  must be PB11
        ETH_MII_TXD0/ETH_RMII_TXD0 -------> PG13  must be PB12
        ETH_MII_TXD1/ETH_RMII_TXD1 -------> PG14  must be PB13
                                                  */
  ...
  /* Configure PG11 - PB11, PG14 - PB12 and PG13 - PB13 */
