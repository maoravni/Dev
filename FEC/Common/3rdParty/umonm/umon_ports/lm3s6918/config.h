 ...
 */
#define CPU_LE
#define SYSCLKFREQ		50000000
#define PLATFORM_NAME	"X1AP"
#define CPU_NAME		"LM3S6918"
 ...
 * The flash on this device is occupies 0 thru 0x3ffff.
 * Each sector is 1K...
 */
#define FLASHBANKS				1
#define FLASH_BANK0_BASE_ADDR  	0
#define FLASH_PROTECT_RANGE  	"0-127"		/* Protect first 128K */
#define FLASH_LARGEST_SECTOR    1024
...
#define TFSSPARESIZE    		1024
#define TFSSTART        		0x38000
#define TFSEND          		0x3fbff
#define TFSSPARE        		(TFSEND+1)
#define TFSSECTORCOUNT			31	/* Does not include SPARE */
#else
#define TFSSPARESIZE    		0
#define TFSSTART        		0x38000
#define TFSEND          		0x3ffff
#define TFSSPARE        		0
#define TFSSECTORCOUNT			32
#endif
...
#define TIMER_TICKS_PER_MSEC (SYSCLKFREQ/1000)
