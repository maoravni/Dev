...
# SOCCSRC: C source code files in the SOC-specific directory.
# SOCSSRC: Assembly source code files in the SOC-specific directory.
# COMCSRC: C source code files in the common/monitor directory.
# CPUCSRC: C source code files in the common/cpu directory.
#
LOCSOBJ		= $(LOCSSRC:%.S=%.o)
LOCCOBJ		= $(LOCCSRC:%.c=%.o)
SOCCOBJ     = $(SOCCSRC:$(SOCDIR)/%.c=%.o)
SOCSOBJ     = $(SOCSSRC:$(SOCDIR)/%.S=%.o)
CPUSOBJ		= $(CPUSSRC:%.S=%.o)
CPUCOBJ		= $(CPUCSRC:%.c=%.o)
COMCOBJ		= $(COMCSRC:%.c=%.o)
