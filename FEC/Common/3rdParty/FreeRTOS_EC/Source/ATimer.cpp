...
ATimer &ATimer::Create(const portCHAR *pcTimerName, portTickType xTimerPeriod, unsigned portBASE_TYPE uxAutoReload){//, void * pvTimerID, tmrTIMER_CALLBACK pxCallbackFunction) {
	assert(!IsValid());
