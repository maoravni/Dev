...
#define FEC2_PINS_CONFIG_H_


static const PIN_CNFG_ST GPIO_ZeroCross[] = {
/*----------------------------------------------------------------------------*/
...
static const PIN_CNFG_ST GPIO_Inputs[] = {
/*---------------------------------------------------------------------------*/
...
static const PIN_CNFG_ST GPIO_Communications[] = {
/*---------------------------------------------------------------------------*/
/*                              I 2 C   P I N S                              */
/*---------------------------------------------------------------------------*/
/* 139 */  {/* I2C1 SCL */
...
static const PIN_CNFG_ST GPIO_Outputs[] = {
/*---------------------------------------------------------------------------*/
/*                             G P I O _ O U T s                             */
/*---------------------------------------------------------------------------*/
           {/* GPIO_OUT1 SAFETY*/
...
static const PIN_CNFG_ST GPIO_Leds[] = {
        {/* MCU_LED1 */
           1,                        /* pre_out_val */
           0xFF,                     /* AltFunNum  */
           0xFF,                     /* pin_src  */
...
static const PIN_CNFG_ST GPIO_ST_PSOC_IO[] =
{
        {/* psoc 1 line 1*/
           0,                        /* pre_out_val */
           0xFF,                     /* AltFunNum  */
        ...
        {/* psoc 8 line 2 / FEC3: I2C Power Disable*/
           0,                        /* pre_out_val */
           0xFF,                     /* AltFunNum  */
           GPIO_PinSource4,         /* pin_src  */
           0,                        /* port_src */
...
static const PIN_CNFG_ST GPIO_A2D[] =
{
/*************************         A 2 D s          ***************************/
/* 1 */   {/* ADC1_IN0  (PA0) */
              1,                        /* pre_out_val */
...
/******************************************************************************/
      ...
      },
      {
        ...
        {                                  /* NVIC_InitTypeDef NvicParams   */
          ...
          (uint8_t)(configMAX_SYSCALL_INTERRUPT_PRIORITY>>4)+4, /* NVIC_IRQChannelPreemptionPriority */  //mast be above configMAX_SYSCALL_INTERRUPT_PRIORITY
          0,                               /* NVIC_IRQChannelSubPriority    */
          ENABLE,                          /* NVIC_IRQChannelCmd            */
        }
      },
