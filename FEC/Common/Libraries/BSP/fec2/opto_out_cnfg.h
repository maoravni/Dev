...
/*                                      OPTO_OUT1   OPTO_OUT2   OPTO_OUT3    OPTO_OUT4    OPTO_OUT5    OPTO_OUT6    OPTO_OUT7   OPTO_OUT8   OPTO_OUT9   OPTO_OUT10  OPTO_OUT11  OPTO_OUT12  SAFETY      */
  ...
  static GPIO_TypeDef*   DO_PortOf[] = {GPIOE,      GPIOA,      GPIOE,       GPIOB,       GPIOE,       GPIOE,       GPIOE,      GPIOE,    }; //, GPIOD       };
                         
  static const uint16_t   DO_PinOf[] = {GPIO_Pin_8, GPIO_Pin_6, GPIO_Pin_10, GPIO_Pin_9, GPIO_Pin_12, GPIO_Pin_13, GPIO_Pin_5, GPIO_Pin_6};//, GPIO_Pin_12 };
