...
//#define traceTASK_SWITCHED_OUT() ITM_EVENT8_WITH_PC(2,0);
//#define traceTASK_SWITCHED_IN() ITM_EVENT8_WITH_PC(2, pxCurrentTCB->uxTCBNumber);
...
//			uxReturn = pxTCB->uxTaskNumber;
            //- TODO: maora 16 Dec 2012: Find out why uxTaskNumber is always 0.
...
void vTaskCheckForStackOverflow()
{
    taskFIRST_CHECK_FOR_STACK_OVERFLOW();
    taskSECOND_CHECK_FOR_STACK_OVERFLOW();
}
