...
#define MDRIVER_SECTOR_SIZE   512       /* Sector size */
#define MDRIVER_TOTAL_BLOCKS 512 /* Block Count */

#define MDRIVER_VOLUME0_SIZE  (MDRIVER_SECTOR_SIZE * MDRIVER_TOTAL_BLOCKS) /* defintion for size of ramdrive0 */

#define MDRIVER_MEM_LONG_ACCESS   0         /* set this value to 1 if 32bit access available */
